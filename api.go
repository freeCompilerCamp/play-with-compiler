...
func main() {
    ...
    playground := types.Playground{Domain: config.PlaygroundDomain, DefaultDinDInstanceImage: "freecompilercamp/pwc:18.04", AvailableDinDInstanceImages: []string{"freecompilercamp/pwc:18.04","freecompilercamp/pwc:16.04","freecompilercamp/pwc:rose-bug","freecompilercamp/pwc:llvm10","fcc_docker:test"}, AllowWindowsInstances: config.NoWindows, DefaultSessionDuration: d, Extras: map[string]interface{}{"LoginRedirect": "http://localhost:3000"}}
